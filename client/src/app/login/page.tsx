    ...
    return (
        <div className="flex items-center justify-center min-h-[100vh] w-[100vw]  rounded-2xl bg-gray-50">
            <motion.div
                ...
                className="w-full max-w-md bg-white rounded-4xl shadow-xl overflow-hidden"
            >
                ...
                <div className="p-8">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full flex items-center justify-center py-3 px-4 rounded-3xl shadow-sm text-sm font-medium text-white bg-linear-to-r from-black   to-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition-colors"
                        >
